  ...
  return (
    <div className="cart">      
      <section className="cart-items">
        {cart.length === 0 ? (
          <h4>Your cart is currently empty. <br></br> <Link to="/shop" className="shop-link">Check out our shop and add some products</Link></h4>
        ) : (
          <>
            ...
            <p>
              <Link to="/shop" className="shop-link">Click here to contine shopping</Link>
            </p>
          </>
      )}
      </section>
      <section className="summary">
        ...
        <p className="summary-list-item">
          <span className="summary-sub-heading">Subtotal ({amountOfItems} items)</span> 
